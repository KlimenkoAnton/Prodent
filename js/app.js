 ...
 */
    ...
    (() => {
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            if (phoneInput) phoneInput.forEach((input => {
            ...
            function onInputFocus(e) {
                const input = e.target;
                if (input.dataset.inputLabel) input.parentElement.insertAdjacentHTML("beforeend", `<div class="form__label-block">${input.dataset.inputLabel}</div>`);
            }
            function onInputFocusOut(e) {
                const input = e.target;
                if (input.parentElement.querySelector(".form__label-block")) input.parentElement.removeChild(input.parentElement.querySelector(".form__label-block"));
            }
        }));
        ...
        function initSliders() {
            if (document.querySelector(".slider-hero")) new swiper_core_Swiper(".slider-hero__slider", {
                ...
                navigation: {
                    prevEl: ".slider-hero__arrows .arrows__arrow_prev",
                    nextEl: ".slider-hero__arrows .arrows__arrow_next"
                },
                on: {}
            });
            if (document.querySelector(".slider-services")) new swiper_core_Swiper(".slider-services__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                speed: 800,
                loop: true,
                navigation: {
                    prevEl: ".slider-services__arrows .arrows__arrow_prev",
                    nextEl: ".slider-services__arrows .arrows__arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 2,
            ...
            if (document.querySelector(".slider-specialists")) new swiper_core_Swiper(".slider-specialists__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                speed: 800,
                loop: true,
                navigation: {
                    prevEl: ".slider-specialists__arrows .arrows__arrow_prev",
                    nextEl: ".slider-specialists__arrows .arrows__arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".stock")) {
                const resizableSwiper = (breakpoint, swiperClass, swiperSettings, callback) => {
                    ...
                    const checker = function() {
                        if (breakpoint.matches) return enableSwiper(swiperClass, swiperSettings); else {
                            if (swiper !== void 0) swiper.destroy(false, true);
                            return;
                        }
                    };
                ...
                resizableSwiper("(max-width: 992px)", ".stock__body", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerGroupSkip: 0,
                    ...
                    navigation: {
                        prevEl: ".stock__arrows .arrows__arrow_prev",
                        nextEl: ".stock__arrows .arrows__arrow_next"
                    }
                });
            }
            if (document.querySelector(".slider-reviews")) new swiper_core_Swiper(".slider-reviews__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                autoHeight: true,
                ...
                loop: true,
                pagination: {
                    el: ".controlls-slider__dotts--reviews",
                    clickable: true
                },
                navigation: {
                    prevEl: ".slider-reviews__controlls .arrow-controls_prev",
                    nextEl: ".slider-reviews__controlls .arrow-controls_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".slider-gallery")) new swiper_core_Swiper(".slider-gallery__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                loop: true,
                pagination: {
                    el: ".controlls-slider__dotts--gallery",
                    clickable: true
                },
                navigation: {
                    prevEl: ".slider-gallery__controlls .arrow-controls_prev",
                    nextEl: ".slider-gallery__controlls .arrow-controls_next"
                },
                on: {}
            });
            if (document.querySelector(".slider-card-sertification")) new swiper_core_Swiper(".slider-card-sertification__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                speed: 800,
                loop: true,
                navigation: {
                    prevEl: ".card-sertification__arrows .arrows__arrow_prev",
                    nextEl: ".card-sertification__arrows .arrows__arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 2,
...
***************************************************************************** */
        ...
        window.addEventListener("scroll", (function() {
            ...
            if (window.innerWidth > 992) window.scrollY >= headerHeight ? headerFixed.classList.add("header-scroll") : headerFixed.classList.remove("header-scroll"); else if (window.innerWidth < 992) window.scrollY >= headerHeight ? header.classList.add("header-scroll") : header.classList.remove("header-scroll");
        }));
                ...
                elements.forEach((element => {
                    ...
                    const interval = setInterval((() => {
                        ...
                        if (distance < 0) {
                            ...
                            element.innerHTML = `\n          <div class="timer-item-stock__remove">\n            <div class="timer-item-stock__remove-label">Акция закончилась</div>\n          </div>`;
                        } else element.innerHTML = `\n          <div class="timer-item-stock__item">\n            <div class="timer-item-stock__time timer-item-stock__time--days">${days < 10 ? "0" + days : days}</div>\n            <div class="timer-item-stock__label timer-item-stock__label--days">${declOfNum(days, [ "День", "Дня", "Дней" ])}</div>\n          </div>\n          <div class="timer-item-stock__item">\n            <div class="timer-item-stock__time timer-item-stock__time--hourse">${hours < 10 ? "0" + hours : hours}</div>\n            <div class="timer-item-stock__label timer-item-stock__label--hourse">${declOfNum(hours, [ "Час", "Часа", "Часов" ])}</div>\n          </div>\n          <div class="timer-item-stock__item">\n            <div class="timer-item-stock__time timer-item-stock__time--minutes">${minutes < 10 ? "0" + minutes : minutes}</div>\n            <div class="timer-item-stock__label timer-item-stock__label--minutes">${declOfNum(minutes, [ "Минута", "Минуты", "Минут" ])}</div>\n          </div>\n          <div class="timer-item-stock__item">\n            <div class="timer-item-stock__time timer-item-stock__time--seconds">${seconds < 10 ? "0" + seconds : seconds}</div>\n            <div class="timer-item-stock__label timer-item-stock__label--seconds">${declOfNum(seconds, [ "Секунда", "Секунды", "Секунд" ])}</div>\n          </div>`;
                        if (document.querySelector(".timer-item-stock__body--stock")) if (distance < 0) {
                            clearInterval(interval);
                            element.innerHTML = `\n            <div class="timer-item-stock__remove">\n              <div class="timer-item-stock__remove-label">Акция закончилась</div>\n            </div>`;
                        } else element.innerHTML = `\n            <div class="timer-item-stock__item">\n              <div class="timer-item-stock__time timer-item-stock__time--days">${days < 10 ? "0" + days : days}</div>\n              <div class="timer-item-stock__label timer-item-stock__label--days">${declOfNum(days, [ "День", "Дня", "Дней" ])}</div>\n            </div>\n            <div class="timer-item-stock__item">\n              <div class="timer-item-stock__time timer-item-stock__time--hourse">${hours < 10 ? "0" + hours : hours}</div>\n              <div class="timer-item-stock__label timer-item-stock__label--hourse">${declOfNum(hours, [ "Час", "Часа", "Часов" ])}</div>\n            </div>\n            <div class="timer-item-stock__item">\n              <div class="timer-item-stock__time timer-item-stock__time--minutes">${minutes < 10 ? "0" + minutes : minutes}</div>\n              <div class="timer-item-stock__label timer-item-stock__label--minutes">${declOfNum(minutes, [ "Минута", "Минуты", "Минут" ])}</div>\n            </div>\n            <div class="timer-item-stock__item">\n              <div class="timer-item-stock__time timer-item-stock__time--seconds">${seconds < 10 ? "0" + seconds : seconds}</div>\n              <div class="timer-item-stock__label timer-item-stock__label--seconds">${declOfNum(seconds, [ "Секунда", "Секунды", "Секунд" ])}</div>\n            </div>`;
                    }), 1e3);
